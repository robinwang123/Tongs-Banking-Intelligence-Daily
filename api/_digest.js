...
4. Never invent URLs.
5. Quantitative claims (amounts, percentages, market share) MUST cite a specific source. If unverifiable, use qualifiers like "reported to be" — never fabricate numbers.
6. Time scope: only report developments from the last 14 days unless providing background context.
