...
<style>
  ...
  .content h1:first-child,.content h2:first-child{margin-top:0;background:#EAF4FB !important;border-left:3px solid #1a5fa8;padding:12px 14px;border-radius:0 8px 8px 0;border-bottom:none;margin-left:-14px;color:#0B2E4E !important}
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .content h1:first-child,.content h2:first-child{background:#EAF4FB !important;color:#0B2E4E !important}
